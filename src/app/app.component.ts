...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor(private store: Store<AppState>, private notificationService: NotificationService, private snackbar: MatSnackBar) {
    this.sub = notificationService.noticifation.subscribe(message => {
